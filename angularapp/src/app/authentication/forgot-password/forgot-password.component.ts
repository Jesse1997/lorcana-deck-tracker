...
export class ForgotPasswordComponent implements OnInit {
  ...
  public forgotPassword = (forgotPasswordFormValue) => {
    ...
    const forgotPassDto: ForgotPasswordDto = {
      ...
      clientURI: window.location.hostname === 'localhost' ? 'https://localhost:4200/#/authentication/resetpassword' : 'https://' + window.location.hostname + '/#/authentication/resetpassword'
    }
