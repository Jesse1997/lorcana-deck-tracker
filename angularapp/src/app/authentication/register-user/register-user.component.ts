...
export class RegisterUserComponent implements OnInit {
  ...
  public registerUser = (registerFormValue) => {
    ...
    const user: UserForRegistrationDto = {
      ...
      clientURI: window.location.hostname === 'localhost' ? 'https://localhost:4200/#/authentication/emailconfirmation' : 'https://' + window.location.hostname + '/#/authentication/emailconfirmation'
    };
